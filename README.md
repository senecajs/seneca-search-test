...
```sh
npm install seneca-search-test
```
...
Test utilities for Seneca search plugins.

## Support

If you're using this module and need help, you can:

- Post a [github issue](https://github.com/senecajs/seneca-search-test/issues)
- Tweet to [@senecajs](http://twitter.com/senecajs)
- Ask on the [Gitter](https://gitter.im/senecajs/seneca)

## API

See [source](https://github.com/senecajs/seneca-search-test) for API details.
...
Used for testing Seneca search plugin implementations.
